...
function Testimonials() {
    ...
    const testimonials = [
        {
            name: 'John Doe',
            title: 'Healing Stories from Real People',
            message:
                '"I had been struggling with digestive issues for years. After trying various medications, I finally turned to Ayurveda—and within weeks, I started seeing real changes. I feel lighter, healthier, and more balanced every day."',
            image: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200',
        },
        {
            name: 'Jane Smith',
            title: 'Ayurveda That Transforms Lives',
            message:
                '"I had been struggling with digestive issues for years. After trying various medications, I finally turned to Ayurveda—and within weeks, I started seeing real changes. I feel lighter, healthier, and more balanced every day."',
        ...
        {
            name: 'Bonnie Green',
            title: 'Wellness Journeys with Ayurveda',
            message:
                '"I had been struggling with digestive issues for years. After trying various medications, I finally turned to Ayurveda—and within weeks, I started seeing real changes. I feel lighter, healthier, and more balanced every day."',
         ...
         {
            name: 'John Does',
            title: 'Real Results, Natural Healing',
            message:
                '"I had been struggling with digestive issues for years. After trying various medications, I finally turned to Ayurveda—and within weeks, I started seeing real changes. I feel lighter, healthier, and more balanced every day."',
            image: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200',
        },
  ...
  return (
    <div className='mt-25'>
        <>
            <h1 className="text-center text-4xl font-bold text-white">Testimonials</h1>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center p-8 text-center">
                            <div className="mb-4 text-gray-500">
                                <h3 className="text-lg font-semibold text-white"> Healing Naturally</h3>
